...
func (q *Queries) CreateTransfer(ctx context.Context, arg CreateTransferParams) (PaymentTransfer, error) {
...
func (q *Queries) ListTransfers(ctx context.Context, arg ListTransfersParams) ([]PaymentTransfer, error) {
